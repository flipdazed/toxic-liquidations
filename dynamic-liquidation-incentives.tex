...
Let collateral $c=sP$, with $s$ the remaining units and $P$ the price. The infinitesimal change in collateral value os $dc = P\,ds + s\,dP$ to first order. The seizure contributes $P\,ds=-(1+i)\,da$, and the price move re-marks the remainder by $s\,dP=c\,d(\ln P)$. Therefore remaining collateral is remarked by
\[
